...
# 入力ディレクトリと出力ファイル名
input_file="~/ws/src/pointpillar-ros-node/pointpillar_ros/csv/$1/average_array_ped_size.csv"
output_file="~/ws/src/pointpillar-ros-node/pointpillar_ros/csv/$1/average_average_array_ped_size.csv"
...
# 出力CSVファイルに平均値を保存
echo "Average_Average_Ped_Size" > "$output_file"
